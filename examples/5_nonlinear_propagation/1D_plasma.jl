...
# Grid
# ******************************************************************************************
grid = Grid(zmin=-5e-6, zmax=105e-6, Nz=1101)
...
params = (w0, tau0, dt0, E0)

function source_waveform(z, t, p)
    w0, tau0, dt0, E0 = p
    return E0 * exp(-(t - dt0)^2 / tau0^2) * cos(w0 * (t - dt0))
end
...
# inspect("out.hdf", :Ex)
inspect("out.hdf", :rho)
# plot1D_line("out.hdf", :rho_end)
# plot1D_line("out.hdf", :JE)
